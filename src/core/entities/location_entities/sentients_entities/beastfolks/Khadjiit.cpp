...
Khadjiit::Khadjiit(const char *input_name, const char input_tile, unsigned input_color, unsigned int input_current_x,
                   unsigned int input_current_y, unsigned int input_pocket)

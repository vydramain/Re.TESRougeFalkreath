...
MainMenuRender::MainMenuRender(unsigned input_screen_x, unsigned input_screen_y, MenuData *input_menu_data) {
...
void MainMenuRender::render() {
  ...
  TextPanelsRender::view_question_with_a_choice(0, 0, SCREENMODE_X - 1, SCREENMODE_Y - 1, menu_data->get_title(),

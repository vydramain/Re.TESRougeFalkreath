...
#ifndef TESROUGEFALKREATH_CODE_HEADERS_INGAMEPARTS_LOGICCOMPONENTS_ENEMY_H_
#define TESROUGEFALKREATH_CODE_HEADERS_INGAMEPARTS_LOGICCOMPONENTS_ENEMY_H_
...
class Enemy {
 ...
 public:
  explicit Enemy();
  explicit Enemy(char *, unsigned, unsigned);  // создаём рабочего персонажа
  ~Enemy();
...
#endif  // TESROUGEFALKREATH_CODE_HEADERS_INGAMEPARTS_LOGICCOMPONENTS_ENEMY_H_

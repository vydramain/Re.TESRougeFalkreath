...
#ifndef TESROUGEFALKREATH_CODE_HEADERS_LOGICPARTS_INPUTKEY_H_
#define TESROUGEFALKREATH_CODE_HEADERS_LOGICPARTS_INPUTKEY_H_
...
#endif  // TESROUGEFALKREATH_CODE_HEADERS_LOGICPARTS_INPUTKEY_H_
